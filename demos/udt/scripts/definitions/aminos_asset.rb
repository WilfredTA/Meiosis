...
# This loads the hash of the script object on the current cell. The binary hash of this script object
# references the mruby cell. The args in that script object include the risc-v binary of this file, plus the
# token name and the creator's public key
